   ...
   decompression:
    ...
    Cross-Platform:
      ...
      - under Linux, use default libbz2.so
       (Linux can use faster assembler version - please check if really usefull)

  (c) 2008 Arnaud Bouchez - http://bouchez.info
   Source code licenced under the MPL: see http://www.mozilla.org/MPL/MPL-1.1.html
