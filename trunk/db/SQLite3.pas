...
function SQLite3_Prepare16(db: TSQLiteDB; SQLStatement: PWideChar; nBytes: integer; var hStmt: TSqliteStmt; var pzTail: PWideChar): integer; cdecl; external SQLiteDLL name 'sqlite3_prepare16';
function SQLite3_Prepare16_v2(db: TSQLiteDB; SQLStatement: PWideChar; nBytes: integer; var hStmt: TSqliteStmt; var pzTail: PWideChar): integer; cdecl; external SQLiteDLL name 'sqlite3_prepare16_v2';
...
function SQLite3_ColumnText16(hStmt: TSqliteStmt; ColNum: integer): PWideChar; cdecl; external SQLiteDLL name 'sqlite3_column_text16';
